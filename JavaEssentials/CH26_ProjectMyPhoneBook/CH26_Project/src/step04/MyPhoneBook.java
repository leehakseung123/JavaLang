...
//        }
//        System.out.println("-----------------------------------");
        // 3. 해시맵에 들어 있는 모든 내용을 출력한다.(확인용)

        PhoneInfo pInfo = map.get(name);    // 4.입력된 값을 키로 해시맵에서 값을 가져온다.
        pInfo.showPhoneInfo();  // 5. PhoneInfo의 showPhone Info()메서드를 저장된 정보를 출력한다.
    }
